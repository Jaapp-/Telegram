...
public class BuildVars {
    ...
    public static int APP_ID = 11492;
    public static String APP_HASH = "255d7ef55fc877312df68ae7603e3865";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.messenger.mad_otter.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
