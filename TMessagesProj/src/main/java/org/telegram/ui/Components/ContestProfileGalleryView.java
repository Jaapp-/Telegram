...
public class ContestProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ContestProfileGalleryView(Context context, ActionBar parentActionBar, RecyclerListView parentListView, Callback callback) {
        super(context);
    ...
    public ContestProfileGalleryView(Context context, long dialogId, ActionBar parentActionBar, RecyclerListView parentListView, ContestProfileActivity.AvatarImageView parentAvatarImageView, int parentClassGuid, Callback callback) {
        super(context);
    ...
    public class ViewPagerAdapter extends Adapter {
        ...
        public ViewPagerAdapter(Context context, ContestProfileActivity.AvatarImageView parentAvatarImageView, ActionBar parentActionBar) {
    ...
    private class AvatarImageView extends BackupImageView {
        ...
        public void invalidate() {
            super.invalidate();
            if (invalidateWithParent) {
                ContestProfileGalleryView.this.invalidate();
            }
        }
    }
