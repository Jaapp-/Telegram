...
public class ContestProfileBirthdayEffect extends View {

    private final int currentAccount;
    private final long dialogId;
    private final ContestProfileActivity profileActivity;
    ...
    public ContestProfileBirthdayEffect(ContestProfileActivity profileActivity, BirthdayEffectFetcher fetcher) {
...
//                    }
    ...
    public static class BirthdayEffectFetcher {
        ...
        public ArrayList<ContestProfileBirthdayEffect> views = new ArrayList<>();

        public void addView(ContestProfileBirthdayEffect effect) {
            views.add(effect);
        }

        public void removeView(ContestProfileBirthdayEffect effect) {
            views.remove(effect);
