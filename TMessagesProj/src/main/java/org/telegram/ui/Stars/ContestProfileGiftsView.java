...
public class ContestProfileGiftsView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ContestProfileGiftsView(Context context, int currentAccount, long dialogId, @NonNull View avatarContainer, ContestProfileActivity.AvatarImageView avatarImage, Theme.ResourcesProvider resourcesProvider) {
        super(context);
...
//        }
    ...
    public final class Gift {
        ...
        public final ButtonBounce bounce = new ButtonBounce(ContestProfileGiftsView.this);
