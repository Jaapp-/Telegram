...
public class ContestProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final ContestProfileActivity.AvatarImageView avatarImage;
    ...
    private class StoryCircle {
        public StoryCircle(TL_stories.StoryItem storyItem) {
            ...
            this.imageReceiver.setParentView(ContestProfileStoriesView.this);
            if (attached) {
        ...
        boolean read = false;
        float scale = 1;
        final AnimatedFloat readAnimated = new AnimatedFloat(ContestProfileStoriesView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
        final AnimatedFloat indexAnimated = new AnimatedFloat(ContestProfileStoriesView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
        final AnimatedFloat scaleAnimated = new AnimatedFloat(ContestProfileStoriesView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
    ...
    public ContestProfileStoriesView(Context context, int currentAccount, long dialogId, boolean isTopic, @NonNull View avatarContainer, ContestProfileActivity.AvatarImageView avatarImage, Theme.ResourcesProvider resourcesProvider) {
        super(context);
...
//                float cx = left + r + ix;
    ...
    private final StoryViewer.PlaceProvider provider = new StoryViewer.PlaceProvider() {
        ...
        public boolean findView(long dialogId, int messageId, int storyId, int type, StoryViewer.TransitionViewHolder holder) {
            ...
            holder.avatarImage = null;
            holder.view = ContestProfileStoriesView.this;
            holder.clipTop = 0;
            holder.clipBottom = AndroidUtilities.displaySize.y;
            holder.clipParent = (View) getParent();
            if (a != null && b != null) {
